...
public class S6Helper implements Runnable, Comparable<S6Helper> {

    public static final String serverName = "SERVER6";
    public static final String Quorum = " SERVER1 SERVER7"; // needs to forward related messages only to SERVER3
    public static ArrayList<S6Helper> serverThreads = new ArrayList<S6Helper>();
    public static ArrayList<S6Helper> clientThreads = new ArrayList<S6Helper>();
    public static PriorityQueue<S6Helper> clientWaitList = new PriorityQueue<S6Helper>();
    ...
    public int compareTo(S6Helper other) {
        return this.requestTime.compareTo(other.requestTime);
    }

    public S6Helper(Socket connection, BufferedWriter xS0, CountDownLatch xlatch, Object xlock) {
        try {
