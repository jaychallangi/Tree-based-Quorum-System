...
public class C4Helper implements Runnable {

    public static ArrayList<C4Helper> servers = new ArrayList<C4Helper>();
    private Socket socket;
    private BufferedReader bufferedReader;
    private BufferedWriter bufferedWriter;
    public static BufferedWriter toS0;
    private String name;
    public static final String clientName = "CLIENT4";
    ...
    public C4Helper(Socket connection, BufferedWriter S0, CountDownLatch xlatch, Object xlock) {
        try {
