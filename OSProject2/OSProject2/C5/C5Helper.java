...
public class C5Helper implements Runnable {

    public static ArrayList<C5Helper> servers = new ArrayList<C5Helper>();
    private Socket socket;
    private BufferedReader bufferedReader;
    private BufferedWriter bufferedWriter;
    public static BufferedWriter toS0;
    private String name;
    public static final String clientName = "CLIENT5";
    ...
    public C5Helper(Socket connection, BufferedWriter S0, CountDownLatch xlatch, Object xlock) {
        try {
