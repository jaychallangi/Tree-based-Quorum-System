...
public class S7Helper implements Runnable, Comparable<S7Helper> {

    public static final String serverName = "SERVER7";
    public static final String Quorum = " SERVER1 SERVER3"; // needs to forward related messages only to SERVER3
    public static ArrayList<S7Helper> serverThreads = new ArrayList<S7Helper>();
    public static ArrayList<S7Helper> clientThreads = new ArrayList<S7Helper>();
    public static PriorityQueue<S7Helper> clientWaitList = new PriorityQueue<S7Helper>();
    ...
    public int compareTo(S7Helper other) {
        return this.requestTime.compareTo(other.requestTime);
    }

    public S7Helper(Socket connection, BufferedWriter xS0, CountDownLatch xlatch, Object xlock) {
        try {
