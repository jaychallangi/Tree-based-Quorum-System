...
public class S7 {
    ...
    public S7(String S0address, int S0port, int port) {
        try {
    ...
    private void startServer() {
        ...
        try {
            if(!server.isClosed()){
                ...
                S7Helper Parent = new S7Helper(p, bufferedWriter,latch,lock);
            ...
            while (!server.isClosed()) {
                ...
                S7Helper handler = new S7Helper(clients, bufferedWriter, latch, lock);
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        S7 server = new S7("10.176.69.51", 5050, 5057);// Change S0addess to IP of dx20
    }
}
