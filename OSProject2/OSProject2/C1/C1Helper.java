...
public class C1Helper implements Runnable {

    public static ArrayList<C1Helper> servers = new ArrayList<C1Helper>();
    private Socket socket;
    private BufferedReader bufferedReader;
    private BufferedWriter bufferedWriter;
    public static BufferedWriter toS0;
    private String name;
    public static final String clientName = "CLIENT1";
    ...
    public C1Helper(Socket connection, BufferedWriter S0, CountDownLatch xlatch, Object xlock) {
        try {
