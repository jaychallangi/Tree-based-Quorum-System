...
//Will be run on dc22 whose ip address is 10.176.69.53
public class S2 {
    private ServerSocket server;
    private Socket client; // to S0
    public BufferedWriter bufferedWriter;
    private String name = "SERVER2";
    ...
    public S2(String S0address, int S0port, int port) {
        try {
    ...
    private void startServer() {
        ...
        try {
            if(!server.isClosed()){
                ...
                S2Helper Parent = new S2Helper(p, bufferedWriter,latch,lock);
            ...
            while (!server.isClosed()) {
                ...
                S2Helper handler = new S2Helper(clients, bufferedWriter, latch, lock);
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        S2 server = new S2("10.176.69.51", 5050, 5052);// Change S0addess to IP of dx20
    }
}
