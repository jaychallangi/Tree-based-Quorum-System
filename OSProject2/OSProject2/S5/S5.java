...
public class S5 {
    ...
    public S5(String S0address, int S0port, int port) {
        try {
    ...
    private void startServer() {
        ...
        try {
            if(!server.isClosed()){
                ...
                S5Helper Parent = new S5Helper(p, bufferedWriter,latch,lock);
            ...
            while (!server.isClosed()) {
                ...
                S5Helper handler = new S5Helper(clients, bufferedWriter, latch, lock);
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        S5 server = new S5("10.176.69.51", 5050, 5055);// Change S0addess to IP of dx20
    }
}
