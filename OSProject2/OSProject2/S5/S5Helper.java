...
public class S5Helper implements Runnable, Comparable<S5Helper> {

    public static final String serverName = "SERVER5";
    public static final String Quorum = " SERVER1 SERVER2"; // needs to forward related messages only to SERVER2
    public static ArrayList<S5Helper> serverThreads = new ArrayList<S5Helper>();
    public static ArrayList<S5Helper> clientThreads = new ArrayList<S5Helper>();
    public static PriorityQueue<S5Helper> clientWaitList = new PriorityQueue<S5Helper>();
    ...
    public int compareTo(S5Helper other) {
        return this.requestTime.compareTo(other.requestTime);
    }

    public S5Helper(Socket connection, BufferedWriter xS0, CountDownLatch xlatch, Object xlock) {
        try {
