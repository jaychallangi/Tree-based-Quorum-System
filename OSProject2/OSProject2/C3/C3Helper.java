...
public class C3Helper implements Runnable {

    public static ArrayList<C3Helper> servers = new ArrayList<C3Helper>();
    private Socket socket;
    private BufferedReader bufferedReader;
    private BufferedWriter bufferedWriter;
    public static BufferedWriter toS0;
    private String name;
    public static final String clientName = "CLIENT3";
    ...
    public C3Helper(Socket connection, BufferedWriter S0, CountDownLatch xlatch, Object xlock) {
        try {
